...
const routes = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              ...
              models: () => [
                import('/Users/a/Desktop/qiankun/umi-plugin-qiankun-master/examples/app1/pages/user/model.js').then(
                  m => {
      ...
      },
      {
        component: () =>
          React.createElement(
            require('/Users/a/Desktop/qiankun/umi-plugin-qiankun-master/node_modules/umi-build-dev/lib/plugins/404/NotFound.js')
              .default,
