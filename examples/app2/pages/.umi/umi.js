...
import findRoute, {
  getUrlQuery,
} from '/Users/a/Desktop/qiankun/umi-plugin-qiankun-master/node_modules/umi-build-dev/lib/findRoute.js';
import moduleBeforeRenderer0 from '/Users/a/Desktop/qiankun/umi-plugin-qiankun-master/lib/slave/lifecycles.js';
import {
  genMount as qiankun_genMount,
  genBootstrap as qiankun_genBootstrap,
  genUnmount as qiankun_genUnmount,
} from '/Users/a/Desktop/qiankun/umi-plugin-qiankun-master/lib/slave/lifecycles.js';
...
plugins.use(require('../../../../lib/slave/runtimePlugin.js'));
...
// client render
if (__IS_BROWSER) {
  if (typeof moduleBeforeRenderer0 === 'function') {
    const promiseOfmoduleBeforeRenderer0 = moduleBeforeRenderer0();
    if (promiseOfmoduleBeforeRenderer0 && promiseOfmoduleBeforeRenderer0.then) {
      moduleBeforeRendererPromises.push(promiseOfmoduleBeforeRenderer0);
    }
  }
...
export const bootstrap = qiankun_genBootstrap(
  Promise.all(moduleBeforeRendererPromises),
  render,
);
export const mount = qiankun_genMount();
export const unmount = qiankun_genUnmount('app2');
